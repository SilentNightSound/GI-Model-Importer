...
# Removes the outline on character models
# This is a more limited version of the set_color script, but simpler to use

# Place in Mod folder and run with python genshin_remove_outlines.py
